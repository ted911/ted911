...
| :--- | :--- |
| **Refactoring** | Optimized `Spring Batch` tasklets by ensuring **SRP** compliance and migrating legacy db configs (H2). |
| **DevOps** | Established local **Kubernetes** environments for microservices (Admin, API, Batch). |
| **Standardization** | Defined strict **SonarQube/PMD** static analysis policies to enforce "Clean as You Code". |
| **Automation** | Developed **n8n** pipelines for automated monitoring and Telegram notifications. |
